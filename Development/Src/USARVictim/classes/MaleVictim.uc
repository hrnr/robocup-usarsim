Class MaleVictim extends VictimPawn config(USAR) placeable;
...
defaultproperties
{
	...
	*/
	...
	defaultMesh=SkeletalMesh'VictimPackage.Mesh.GenericMale'
	defaultPhysicsAsset=PhysicsAsset'VictimPackage.Mesh.GenericMale_Physics'
	defaultAnimTree=AnimTree'VictimPackage.animation.GenericMale_AnimTree'
	defaultAnimSet.Add(AnimSet'VictimPackage.animation.GenericMale_AnimSet')

	Begin Object Name=WPawnSkeletalMeshComponent
		SkeletalMesh=SkeletalMesh'VictimPackage.Mesh.GenericMale'
		PhysicsAsset=PhysicsAsset'VictimPackage.Mesh.GenericMale_Physics'
