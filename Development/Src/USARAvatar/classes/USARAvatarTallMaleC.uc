...
/*
 * USARAvatarTallMaleC: Class handling the skeletal mesh SK_UsarAvatar_TallMaleC
 */
class USARAvatarTallMaleC extends USARAvatarCommon;
...
DefaultProperties
{
 ...
 Begin Object class=SkeletalMeshComponent Name=UsarAvatar_MaleA
	...
	BlockActors=true
        ...
        SkeletalMesh=SkeletalMesh'UsarAvatar_TallMaleC.Mesh.SK_UsarAvatar_TallMaleC'
        AnimSets(0)=AnimSet'UsarAvatar_TallMaleC.AnimSet.AnimSet_UsarAvatar_TallMaleC'
        AnimTreeTemplate=AnimTree'UsarAvatar_TallMaleC.AnimTree.AnimTree_UsarAvatar_TallMaleC'
