...
/*
 * USARAvatarTallMaleD: Class handling the skeletal mesh SK_UsarAvatar_TallMaleD
 */
class USARAvatarTallMaleD extends USARAvatarCommon;
...
DefaultProperties
{
 ...
 Begin Object class=SkeletalMeshComponent Name=UsarAvatar_MaleA
    ...
    SkeletalMesh=SkeletalMesh'UsarAvatar_TallMaleD.Mesh.SK_UsarAvatar_TallMaleA'
    AnimSets(0)=AnimSet'UsarAvatar_TallMaleD.AnimSet.AnimSet_UsarAvatar_TallMaleA'
    AnimTreeTemplate=AnimTree'UsarAvatar_TallMaleD.AnimTree.AnimTree_UsarAvatar_TallMaleA'
